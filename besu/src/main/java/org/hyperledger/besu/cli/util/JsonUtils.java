...
public class JsonUtils {
    public static String readJsonExcludingField(File genesisFile, String excludedFieldName) {
    ...
    private static String handleObject(JsonParser parser, String excludedFieldName) throws IOException {
    ...
    private static String handleValue(JsonParser parser, String excludedFieldName) throws IOException {
    ...
    private static String handleArray(JsonParser parser, String excludedFieldName) throws IOException {
